...
browse.hee <- forest.sim(xcorewidth=140, ycorewidth=140, nreps=24,
                            burnin=20,nyears=40,
                            browse.scenario = "hee",
                            force.processors = 12,
                         ram.max = 5000)
save(browse.hee,file='output/browse_hee.Rdata')
browse.prob0 <- forest.sim(xcorewidth=140, ycorewidth=140, nreps=24,
                         burnin=20,nyears=40,
...
browse.prob2 <- forest.sim(xcorewidth=140, ycorewidth=140, nreps=24,
                           burnin=20,nyears=40,
                           browse.scenario = "custom",
                           prob.browsed = 0.2,
                           force.processors = 12,
...
browse.prob4 <- forest.sim(xcorewidth=140, ycorewidth=140, nreps=24,
                           burnin=20,nyears=40,
                           browse.scenario = "custom",
                           prob.browsed = 0.4,
                           force.processors = 12,
...
browse.prob6 <- forest.sim(xcorewidth=140, ycorewidth=140, nreps=24,
                           burnin=20,nyears=40,
                           browse.scenario = "custom",
                           prob.browsed = 0.6,
                           force.processors = 12,
...
browse.prob8 <- forest.sim(xcorewidth=140, ycorewidth=140, nreps=24,
                           burnin=20,nyears=40,
                           browse.scenario = "custom",
                           prob.browsed = 0.8,
                           force.processors = 12,
...
browse.prob10 <- forest.sim(xcorewidth=140, ycorewidth=140, nreps=24,
                           burnin=20,nyears=40,
                           browse.scenario = "custom",
                           prob.browsed = 1.0,
                           force.processors = 12,

ba.data <- read.csv("oak_ibm_jabowa Basal Area.csv",header=T)
...
prop.data <- read.csv("oak_ibm_jabowa Prop Oak.csv",header=T)
...
prop.data <- read.csv("noharvest Prop Oak.csv",header=T)

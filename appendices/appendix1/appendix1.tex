...
\title{\normalfont\spacedallcaps{\textbf{S1 Appendix}: SOEL Model Description}} 
\subtitle{\normalfont{Kellner KF\textsuperscript{1}, Swihart RK\textsuperscript{1}. Simulation of oak early life history and interactions with timber harvest via an individual-based model, SOEL. PLOS ONE.}}
...
\begin{figure}
	\centering
	\includegraphics[scale=1]{figures/fig8.pdf}
...
\bibliography{../../../../documents/research/literature/bibtex/references}
